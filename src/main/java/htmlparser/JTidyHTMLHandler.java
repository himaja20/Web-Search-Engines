...
public class JTidyHTMLHandler {
    ...
    protected String getTitle(Element rawDoc) {
        ...
        String title = "";
        NodeList children;
        if (!(rawDoc.getElementsByTagName("title").getLength() == 0)){
        	children = rawDoc.getElementsByTagName("title");
        }
        else if (!(rawDoc.getElementsByTagName("H1").getLength() == 0)){
        	children = rawDoc.getElementsByTagName("H1");
        }
        else if(!(rawDoc.getElementsByTagName("H2").getLength() == 0)){
